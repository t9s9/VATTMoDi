...
from MVALM.modules.vat_module_distill import ATModule, DistillTrainingOptions, VATModule
...
def train(_config, _log: Logger):
    ...
    module = ATModule(model_kwargs=config['model'],
                      optimizer_kwargs=config['optimizer'],
                      lr_scheduler_kwargs=config['lr_scheduler'],
                      caption_type=config['caption_type'],
                      caption_mix_tag=config['caption_mix_tag'],
                      training_kwargs=DistillTrainingOptions(**config['training_kwargs']),
                      )
