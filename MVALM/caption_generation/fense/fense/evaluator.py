...
class Evaluator:
    def __init__(self, batch_size=32, device='cuda', sbert_model="paraphrase-TinyBERT-L6-v2",
                 echecker_model="echecker_clotho_audiocaps_base", error_threshold=0.9, penalty=0.9, use_proxy=False, proxies=None):
    ...
    def encode_sent_sbert(self, sent):
        return self.sbert.encode(sent, convert_to_tensor=True, normalize_embeddings=True, show_progress_bar=False)
